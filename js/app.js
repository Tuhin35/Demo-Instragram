              ...
              <div class="post__footer">
                ...
                <div class="post__infos">
                  ...
                  <div class="post__description">
                    <small>
                      <a class="post__name--underline" style="font-size:25px" href="#">
                          ${post.comments? post.comments[0].user : "No comments for this post"}
                      </a>
                      ${post.comments?post.comments[0].text : "No comments for this post"}
                    </small>
                  </div>
